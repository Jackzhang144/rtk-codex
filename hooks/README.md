...
- **[`codex/`](codex/README.md)** — RTK.md guidance plus a non-authorizing native `PreToolUse` guardrail
...
| Codex CLI | RTK.md + native `PreToolUse` | Prompt guidance; Hook preserves native approval | No by default |
