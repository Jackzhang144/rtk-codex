...
| [`codex/`](../hooks/codex/README.md) | OpenAI Codex CLI | RTK.md guidance, native non-authorizing `PreToolUse` guardrail |
...
| Codex CLI | RTK.md + Rust binary | Prompt guidance plus non-authorizing `PreToolUse` guardrail | No by default |
